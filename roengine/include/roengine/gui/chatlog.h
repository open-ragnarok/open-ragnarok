/* $Id: chatlog.h $ */
#ifndef __GUI_CHATLOG_H
#define __GUI_CHATLOG_H
...
public:
	ChatLog(Element* parent, CacheManager&);
	ChatLog(Element* parent, const TiXmlElement*, CacheManager&);
	~ChatLog();
