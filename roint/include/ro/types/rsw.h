...
/*
    ...
    ------------------------------------------------------------------------------------
*/
#ifndef __RO_TYPES_RSW_H
#define __RO_TYPES_RSW_H
...
#pragma pack(push,1)
	...
	public:
		...
		static RSW::Object* readStream(std::istream& s, const s_obj_ver& ver);
	...
	public:
		...
		bool readData(std::istream& s, const s_obj_ver& ver);
		bool writeData(std::ostream& s, const s_obj_ver& ver) const;
