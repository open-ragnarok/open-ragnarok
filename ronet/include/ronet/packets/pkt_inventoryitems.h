...
/*
    ...
    ------------------------------------------------------------------------------------
*/
#ifndef __RONET_PACKET_INVENTORYITEMS_H
#define __RONET_PACKET_INVENTORYITEMS_H

#include "ronet/packet.h"
#include "ronet/structures.h"

namespace ronet {
	class RONET_DLLAPI pktInventoryItems : public Packet {
	protected:
		struct InventoryItem* items;
		short item_count;
	public:
		pktInventoryItems();
		virtual ~pktInventoryItems();
